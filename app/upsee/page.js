...
export default function UPSEEPredictor() {
  ...
  const handleSubmit = (e) => {
    ...
    router.push(
      `/results?rank=${rank}&domicile=${domicile}&category=${category}&seatType=${seatType}&quota=${quota}`
    )
  }
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-white p-4">
      ...
      <form
        ...
        className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md mt-4 border"
      >
        ...
        >
          <option value="">Are you a resident of UP?</option>
